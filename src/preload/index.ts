...
const api: CandyHavenApi = {
  ...
  nowPlaying: {
    ...
    configureSource: (id, patch) => invoke('nowplaying:source-config', { id, patch }),
    addSource: (draft) => invoke('nowplaying:source-add', draft),
    renameSource: (id, name, note) => invoke('nowplaying:source-rename', { id, name, note }),
    removeSource: (id) => invoke('nowplaying:source-remove', { id }),
    setPollSeconds: (seconds) => invoke('nowplaying:poll', { seconds }),
  ...
  dispatch: {
    ...
    signIn: (email, password) => invoke('dispatch:sign-in', { email, password }),
    signOut: () => invoke('dispatch:sign-out'),
