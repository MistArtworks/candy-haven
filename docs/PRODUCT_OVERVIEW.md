...
| **INTERVAL**                | MULTI-PURPOSE COUNTDOWN TIMER | A break countdown with a grace period that keeps counting past zero, five visual faces, and audio cues.                                                                                                                                                                                                  |
| **CONVENING**               | STREAM STARTING COUNTDOWN     | A "stream starting" countdown that resolves to a single word. Silent by default — nothing should warn an audience it is nearly time.                                                                                                                                                                     |
